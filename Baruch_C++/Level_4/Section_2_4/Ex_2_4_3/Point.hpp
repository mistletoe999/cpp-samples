...
// EDIT: Added new constructor with only one double parameter
...
public:
	...
	//*************EDIT*************
	// Without explicit keyword used as implicit conversion operator
	explicit Point(double value);
	// Point(double value);		// Initialize both x and y with value
	//******************************
