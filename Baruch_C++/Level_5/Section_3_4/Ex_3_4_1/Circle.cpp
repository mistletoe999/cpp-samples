...
namespace KAPIL
{
	...
	{
		// Constructors
		Circle::Circle() : centre(Point(0.0, 0.0)), radius(1.0) {} // Default Constructor : Unit circle

		Circle::Circle(const Point& c, double r) : centre(c), radius(r) {} // Constructor with center and radius parameters

		Circle::Circle(double r, const Point& c) : centre(c), radius(r) {} // Constructor with center and radius parameters		}

		Circle::Circle(const Circle& circle) : centre(circle.centre), radius(circle.radius) {} // Copy Constructor 
