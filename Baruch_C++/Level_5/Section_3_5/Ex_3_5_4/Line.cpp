...
// EDIT: Added Draw function. The function overrides the Draw 
// function defined in the Shape class
...
namespace KAPIL
{
	namespace CAD
	{
		...
		void Line::Draw() const { // Draw function for Line
			cout << "Let's draw a line with Point 1 = " << lineStart << " and Point 2 = " << lineEnd << endl;
		}
